...
- zsh, sheldon, ghq, peco, powerlevel10k, pyenv
...
| `sheldon/plugins.toml` | Sheldon plugin manifest — powerlevel10k, zsh-completions, zsh-autosuggestions, zsh-syntax-highlighting |
...
**zshrc**: `Ctrl+]` triggers `peco-src` — fuzzy-finds ghq-managed repos and `cd`s into them. Sheldon loads plugins (powerlevel10k, completions, autosuggestions, syntax-highlighting), then `compinit` runs.
